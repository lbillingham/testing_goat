...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        Item.objects.create(text='item numero uno', list=correct_list)
        Item.objects.create(text='item numero dos', list=correct_list)
        other_list = List.objects.create()
        Item.objects.create(text='list otra item 1', list=other_list)
        Item.objects.create(text='list otra item 2', list=other_list)

        response = self.client.get('/lists/{:d}/'.format(correct_list.id,))

        self.assertContains(response, 'item numero uno')
        self.assertContains(response, 'item numero dos')
        self.assertNotContains(response, 'list otra item 1')
        self.assertNotContains(response, 'list otra item 2')
